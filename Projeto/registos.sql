...
-- A despejar estrutura para tabela consultas.registos
CREATE TABLE IF NOT EXISTS `registos` (
  ...
  `genero` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '',
...
-- A despejar dados para tabela consultas.registos: ~0 rows (aproximadamente)
